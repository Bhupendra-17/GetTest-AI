...
const Main = () => {
  ...
  const handleGenerateTest = () => {
    ...
    if (!numQuestions || !timeLimit) {
      alert('Please set the number of questions and time limit.');
      return;
    }
        ...
        <div className='w-full max-w-4xl bg-white shadow-xl rounded-3xl p-10 mt-8 hover:shadow-2xl transition duration-300'>
          ...
          <div className='space-y-8'>
            ...
            <div className='p-6 bg-white border border-orange-400 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 flex flex-col items-center text-center'>
              ...
              <p className='text-gray-600 mb-4'>Choose the number of questions and time limit.</p>
              <input
                type='number'
              ...
              <input
                ...
                className='border p-3 rounded-lg w-3/4 text-center shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-400'
              />
            </div>
